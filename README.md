...
**Обо мне:**
Я начинающий ручной тестировщик, мой путь в it начался со стартап проекта VUCHOBE, где я научился основам тестирования. После я прошёл курс по профессии “Инженер по тестированию”.
